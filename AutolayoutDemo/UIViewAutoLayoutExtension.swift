...
extension UIView {
    ...
    func alignRightTo(toItem: UIView, padding: CGFloat) -> [NSLayoutConstraint] {
    ...
    func alignLeftTo(toItem: UIView, padding: CGFloat) -> [NSLayoutConstraint] {
    ...
    func constrainWidthTo(toItem: UIView, multiplier: CGFloat) -> [NSLayoutConstraint] {
        let constraint = NSLayoutConstraint(item: self, attribute: NSLayoutAttribute.Width, relatedBy: NSLayoutRelation.Equal, toItem: toItem, attribute: NSLayoutAttribute.Width, multiplier: multiplier, constant: 0)
        self.superview?.addConstraint(constraint)
        return [constraint]
    }
    ...
    func constrainHeightTo(toItem: UIView, multiplier: CGFloat) -> [NSLayoutConstraint] {
        let constraint = NSLayoutConstraint(item: self, attribute: NSLayoutAttribute.Height, relatedBy: NSLayoutRelation.Equal, toItem: toItem, attribute: NSLayoutAttribute.Height, multiplier: multiplier, constant: 0)
        self.superview?.addConstraint(constraint)
        return [constraint]
    }
